        ...
        <div className="relative">
            <div className="container h-1/3 mx-auto flex flex-col items-center py-12 sm:py-24">
                ...
                <div className="flex justify-center items-center mx-auto">
                    <Link href="./services">
                        <button className="bg-transparent transition duration-150 ease-in-out hover:border-[#63768D] lg:text-xl lg:font-bold  hover:text-[#63768D] rounded border border-[#414288] text-[#414288] px-4 sm:px-10 py-2 sm:py-4 text-sm">
                            <a>Services</a>
                        </button>
                    </Link>
                    <Link href="./about">
                        <button className="ml-4 bg-transparent transition duration-150 ease-in-out hover:border-[#63768D] lg:text-xl lg:font-bold  hover:text-[#63768D] rounded border border-[#414288] text-[#414288] px-4 sm:px-10 py-2 sm:py-4 text-sm" onClick={""}>
                            <a>&nbsp;&nbsp;About&nbsp;&nbsp;</a>
                        </button>
                    </Link>
